...
export default function CreateVendorAdmin({ onClose }) {
  const [formData, setFormData] = useState({ vendorId: '', vendorName: '', username: '', email: '', password: '', phone: '', contactPerson: '' });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({ vendorId: '', vendorName: '', username: '', email: '', password: '', phone: '', contactPerson: '' });
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="form-group">
              ...
              <input type="number" name="vendorId" value={formData.vendorId} onChange={handleChange} placeholder="Enter vendor ID" disabled={loading} />
            </div>

            <div className="form-group">
              <label>Vendor Name <span className="required">*</span></label>
              <input type="text" name="vendorName" value={formData.vendorName} onChange={handleChange} placeholder="Enter vendor name" disabled={loading} />
            </div>
            ...
            <div className="form-group">
              ...
              <input type="text" name="contactPerson" value={formData.contactPerson} onChange={handleChange} placeholder="Enter contact person name" disabled={loading} />
            </div>
